...
✅|SeedSigner[↗︎](https://seedsigner.com)|Single signer: `m/84'/0'/0'` Multisig: `m/48'/0'/0'/2'`|Optional|Yes|[Docs](https://github.com/SeedSigner/seedsigner/blob/main/docs/recovery.md)
