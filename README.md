...
:---:|:---|:---:|---|---|---|---
✅|BitBox01[↗︎](https://shiftcrypto.ch/bitbox01/)|`m/44'`\|`49'`\|`84'/0'/0'`|Required||Not Supported|[Docs](https://shiftcrypto.ch/bitbox01/wallet-sweep/), [Recovery Tool](https://github.com/digitalbitbox/html_backup)|
...
✅|Ledger Nano[↗︎](https://ledger.com/)|`m/44'/0'/0'`|Optional||Not Supported|[Docs](https://support.ledger.com/hc/en-us)
✅|Ledger S[↗︎](https://ledger.com/)|`m/44'/0'/0'`|Optional||Not Supported|[Docs](https://support.ledger.com/hc/en-us)
✅|Trezor One[↗︎](https://trezor.com)|`m/44'`\|`49'/0'/0'`|Optional||Not Supported|[Docs](https://wiki.trezor.io)
✅|Trezor Model T[↗︎](https://trezor.com)|`m/44'`\|`49'/0'/0'`|Optional||Not Supported|[Docs](https://wiki.trezor.io)
✅|KeepKey[↗︎](https://keepkey.zendesk.com/hc/en-us)|`m/44'/0'/0'`|Optional||Not Supported|[Docs](https://keepkey.zendesk.com/hc/en-us/articles/360001449050-How-to-Recover-on-your-KeepKey), [xPub](https://keepkey.zendesk.com/hc/en-us/sections/360000520290-Software), [Compatible Wallets](https://keepkey.zendesk.com/hc/en-us/articles/360001279444-What-Type-of-Wallet-Can-be-Used-to-Recover-KeepKey-)|
