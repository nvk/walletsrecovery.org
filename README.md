...
✅👁⑂|Unchained[↗︎](https://www.unchained.com/)|`m/45'/0'/x'/y`<br /><sub>The x' account-level derivation path can be custom set by user, and the y depth iterates based on number of Unchained products used (key used in multiple multisig vaults or loans). A wallet configuration file is also provided to all clients</sub>|||No|[Docs](https://github.com/unchained-capital), [**Caravan for multisig wallet recovery**](https://unchained-capital.github.io/caravan/#/)
